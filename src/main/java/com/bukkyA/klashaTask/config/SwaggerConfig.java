package com.bukkyA.klashaTask.config;
...
public class SwaggerConfig {
    @Value("${api.info.title: Klasha Task}")
    ...
    @Value("${api.info.contact.name: Bukky Abadaki}")
    private String contactName;
    @Value("${api.info.contact.email: BukkyAbadaki@gmail.com}")
    private String contactEmail;
    @Value("${api.info.contact.url: https://github.com/BukkyAbadaki/Klasha-task}")
